...
unsigned int modbus_update()
{
  if ((*ModbusPort).available())
  {
    ...
    //  supervisao.print("passo 2: ");
    //  supervisao.print(buffer);
    //   supervisao.print(" - ");
    //   for (int ca = 0; ca <= buffer; ca++) supervisao.print(frame[ca]), supervisao.print(" ; ");
    //   supervisao.println();
    ...
    if (buffer > 7)
    {
      ...
      //     supervisao.print("passo 3: ");
      //     supervisao.print(id);
      //     supervisao.print(" - ");
      //     supervisao.println(slaveID);
